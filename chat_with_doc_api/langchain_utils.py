...
def get_all_information(file_name:str, model="gpt-4o-mini"):
    ...
    return info_rag_chain.invoke("Extract the details for all cricket players mentioned in the context, including their name, date of birth, total Test runs, and total ODI runs. If information is unavailable for a player, leave it blank.")
